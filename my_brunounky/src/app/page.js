...
const WhatsappIcon = () => <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M16.75 13.96c.25.13.41.38.41.66v1.38c0 .55-.45 1-1 1h-1.32c-.31 0-.61-.16-.79-.42l-.53-1.12a.93.93 0 00-.77-.42h-1.02c-.34 0-.65.18-.83.45l-.48.69a.94.94 0 01-.78.43h-.42c-1.1 0-2-.9-2-2v-2.34c0-1.1.9-2 2-2h1.38c.34 0 .66.19.83.48l.52.88c.24.4.7.64 1.18.64h.72c.33 0 .63-.19.78-.48l.52-.92c.18-.32.5-.52.86-.52h1.38c.55 0 1 .45 1 1v1.42c0 .28-.16.54-.42.75zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>;
